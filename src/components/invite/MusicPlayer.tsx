  ...
  return (
    <>
      ...
      <button
        ...
        onClick={toggle}
        aria-label={t.music}
        className="glass fixed bottom-4 left-1/2 z-30 flex -translate-x-1/2 items-center gap-2 rounded-full px-4 py-2.5 text-sm font-semibold text-foreground shadow-soft transition-transform hover:scale-105 active:scale-95"
      >
        {playing && !muted ? (
